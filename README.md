...
## YOLOv4 TINY training on our Tangram dataset
Tutorial :https://colab.research.google.com/drive/1PWOwg038EOGNddf6SXDG5AsC8PIcAe-G#scrollTo=nBnwpBV5ZXxQ
Info : https://blog.roboflow.ai/train-yolov4-tiny-on-custom-data-lighting-fast-detection/
...
#### Pip
```bash
# Create a pip env on the project folder
...
Note : if you have CUDA 10.1 version, install tensorflow-gpu==2.2.0 instead of tensorflow-gpu==2.3.0rc0 (which is the version indicated in the requirements-gpu.txt)
